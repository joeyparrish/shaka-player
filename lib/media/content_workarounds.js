...
goog.requireType('shaka.util.DataViewReader');
...
shaka.media.ContentWorkarounds = class {
  ...
  static correctEnca(initSegmentBuffer) {
    ...
    new shaka.util.Mp4Parser()
        ...
        .box('enca', (box) => {
          const reader = /** @type {!shaka.util.DataViewReader} */ (box.reader);
          encaBoxDataView = reader.getDataView();
  ...
  static freeDvvcBox(initSegmentBuffer) {
    ...
    new shaka.util.Mp4Parser()
        ...
        .box('hvc1', (box) => {
          const reader = /** @type {!shaka.util.DataViewReader} */ (box.reader);
          hvcDataView = reader.getDataView();
          hvcStart = box.start;
