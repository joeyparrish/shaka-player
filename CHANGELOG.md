...
## [5.0.0](https://github.com/joeyparrish/shaka-player/compare/v4.0.0...v5.0.0) (2022-05-12)
...
* Add a buffer fullness method ([#3392](https://github.com/joeyparrish/shaka-player/issues/3392)) ([0f00d1c](https://github.com/joeyparrish/shaka-player/commit/0f00d1ce2ca6ab0e69be3dd43c1c7cfa2412217b)), closes [#3389](https://github.com/joeyparrish/shaka-player/issues/3389)
* Add a config to dispatch all emsg boxes. ([#3653](https://github.com/joeyparrish/shaka-player/issues/3653)) ([ea3568d](https://github.com/joeyparrish/shaka-player/commit/ea3568d7261237a571f23524012072008d01c1ae)), closes [#3348](https://github.com/joeyparrish/shaka-player/issues/3348)
* Add a way to listen to all events on a specific target ([dc5d033](https://github.com/joeyparrish/shaka-player/commit/dc5d033be91bdd00b454331d43efc40e1d8bb710))
* Add align and vertical settings to WebVttGenerator ([#3413](https://github.com/joeyparrish/shaka-player/issues/3413)) ([9ffc111](https://github.com/joeyparrish/shaka-player/commit/9ffc111c497f90028d0d1f2662aa9e7563c9694f))
* Add blob-url support ([#3583](https://github.com/joeyparrish/shaka-player/issues/3583)) ([6a03207](https://github.com/joeyparrish/shaka-player/commit/6a032078e934e6517516b225ab993f9e857ff5d2)), closes [#1481](https://github.com/joeyparrish/shaka-player/issues/1481)
* Add callback for apps to pre-process DASH manifests ([#3480](https://github.com/joeyparrish/shaka-player/issues/3480)) ([9afa4eb](https://github.com/joeyparrish/shaka-player/commit/9afa4eb20da67adb0dcb50f34e41f0ea9c109972)), closes [#3339](https://github.com/joeyparrish/shaka-player/issues/3339)
* Add chapters support ([#2972](https://github.com/joeyparrish/shaka-player/issues/2972)) ([160e36b](https://github.com/joeyparrish/shaka-player/commit/160e36be46b1af8ca4448d96f47e12cfac70c6aa))
* Add Common Media Client Data (CMCD) logging support ([#3662](https://github.com/joeyparrish/shaka-player/issues/3662)) ([221637a](https://github.com/joeyparrish/shaka-player/commit/221637a66c04d4fdc4767fea027c48a5601ac972)), closes [#3619](https://github.com/joeyparrish/shaka-player/issues/3619)
...
* Add goToLive method ([#3527](https://github.com/joeyparrish/shaka-player/issues/3527)) ([84b9a89](https://github.com/joeyparrish/shaka-player/commit/84b9a89f045b195df3423f1bcd62a5dc40d42f98))
...
* Add media quality change events ([#3700](https://github.com/joeyparrish/shaka-player/issues/3700)) ([bd7b384](https://github.com/joeyparrish/shaka-player/commit/bd7b384c662b04ca4d9d083cc210ac7776a138a4)), closes [#3431](https://github.com/joeyparrish/shaka-player/issues/3431)
* add modern EME support for FairPlay ([#3776](https://github.com/joeyparrish/shaka-player/issues/3776)) ([6d76a13](https://github.com/joeyparrish/shaka-player/commit/6d76a135e5128dfd47653acea025d0a264d121d5))
...
* Add public access to more drm members. ([1125184](https://github.com/joeyparrish/shaka-player/commit/1125184bfe08863677cb996b0f13d49e18eeade9))
* Add randomUUID polyfill ([#3669](https://github.com/joeyparrish/shaka-player/issues/3669)) ([a72adca](https://github.com/joeyparrish/shaka-player/commit/a72adca9fd62144f70da61314e785074f374427a))
* Add separate audio and video MIME types to Track API ([#3892](https://github.com/joeyparrish/shaka-player/issues/3892)) ([74c491d](https://github.com/joeyparrish/shaka-player/commit/74c491d2e0042f62385813f04e74517cf00fcade)), closes [#3888](https://github.com/joeyparrish/shaka-player/issues/3888)
* add serverCertificateUri in DRM advanced config ([#3358](https://github.com/joeyparrish/shaka-player/issues/3358)) ([9b4502c](https://github.com/joeyparrish/shaka-player/commit/9b4502cc5d04fc1634d63dfdaa5e864fa4a7e341)), closes [#1906](https://github.com/joeyparrish/shaka-player/issues/1906)
* Add support to HLS Image Media Playlists ([#3365](https://github.com/joeyparrish/shaka-player/issues/3365)) ([2a4083b](https://github.com/joeyparrish/shaka-player/commit/2a4083bab89bf683f58be73a0cba5e4c70cf8ae3)), closes [#2429](https://github.com/joeyparrish/shaka-player/issues/2429)
* Adds advanced ABR config options ([#3706](https://github.com/joeyparrish/shaka-player/issues/3706)) ([d667e50](https://github.com/joeyparrish/shaka-player/commit/d667e50aa3a845ce48f818ac4c4118af88164656)), closes [#3422](https://github.com/joeyparrish/shaka-player/issues/3422)
* **ads:** Integrate with non-linear IMA CS ads ([#3639](https://github.com/joeyparrish/shaka-player/issues/3639)) ([9c3bed3](https://github.com/joeyparrish/shaka-player/commit/9c3bed3d601d27c6df27a1e6946a49c86e4f3db4)), closes [#2596](https://github.com/joeyparrish/shaka-player/issues/2596)
* Allow WebP and AVIF image streams ([#3856](https://github.com/joeyparrish/shaka-player/issues/3856)) ([9f3fb46](https://github.com/joeyparrish/shaka-player/commit/9f3fb46d371d52f58bc9a7fc5beefe51890879ed)), closes [#3845](https://github.com/joeyparrish/shaka-player/issues/3845)
* **ARIA:** Add polyfill for ARIAMixin. ([cf2fb90](https://github.com/joeyparrish/shaka-player/commit/cf2fb903cb802cb89c010b60ea4594cc0f40e1b0)), closes [#3378](https://github.com/joeyparrish/shaka-player/issues/3378)
...
* **CodecPreference:** Add preferred codecs config ([9a706ef](https://github.com/joeyparrish/shaka-player/commit/9a706ef90e7829f51edebc6a521b08f800c3ab2b)), closes [#2179](https://github.com/joeyparrish/shaka-player/issues/2179)
* **CodecPreference:** Improve preferredVideoCodecs & preferredAudioCodecs ([#3424](https://github.com/joeyparrish/shaka-player/issues/3424)) ([0579ee7](https://github.com/joeyparrish/shaka-player/commit/0579ee77797548c2e91622ef87a6a9b778437c25))
...
* **dash:** Add support for thumbnail tracks ([#3145](https://github.com/joeyparrish/shaka-player/issues/3145)) ([b9b3cc8](https://github.com/joeyparrish/shaka-player/commit/b9b3cc809828e569af4266ac42bb469abc33f26a))
...
* **dash:** Create segment index only when used ([b16d30c](https://github.com/joeyparrish/shaka-player/commit/b16d30c249586ae569fc9d632e3be593cb095ed8))
* **Dash:** Extract HDR metadata from DASH manifests ([#3226](https://github.com/joeyparrish/shaka-player/issues/3226)) ([f23ee0a](https://github.com/joeyparrish/shaka-player/commit/f23ee0a9af765571cae0257fa4e6b31ee0d64b8a))
...
* **demo:** Add Apple Advanced HLS Stream (TS) with raw AAC ([#3933](https://github.com/joeyparrish/shaka-player/issues/3933)) ([1becadf](https://github.com/joeyparrish/shaka-player/commit/1becadfc93ca06d64d0c9ace37c80213268a1675))
* **demo:** Add MIME type and extra config to custom assets ([24d10ed](https://github.com/joeyparrish/shaka-player/commit/24d10ed590e6583e56991d1fcc5168dec709a73a))
* **demo:** Added demo asset with raw AAC. ([014c7b3](https://github.com/joeyparrish/shaka-player/commit/014c7b302b292a22f62d4e01230b927b33bc51da)), closes [#2337](https://github.com/joeyparrish/shaka-player/issues/2337)
* **demo:** DASH and HLS demo content from MetaCDN ([#3350](https://github.com/joeyparrish/shaka-player/issues/3350)) ([ec9a38f](https://github.com/joeyparrish/shaka-player/commit/ec9a38f39d40cbee4312be9c71a24b43be21cab3))
* **demo:** Make it possible to add custom ad assets with no manifest uri. ([40aa213](https://github.com/joeyparrish/shaka-player/commit/40aa213ccb924fbc23e47f70e6c5633c455e483c)), closes [#3136](https://github.com/joeyparrish/shaka-player/issues/3136)
* **drm:** add 'com.microsoft.playready.recommendation' to probeSupport ([#3308](https://github.com/joeyparrish/shaka-player/issues/3308)) ([d4ea27a](https://github.com/joeyparrish/shaka-player/commit/d4ea27a13360f25e2d4c9d1aa38df2a0ffec6098))
...
* **DRM:** Add preferred key systems config ([6449b30](https://github.com/joeyparrish/shaka-player/commit/6449b30faa76fc5a6e48814c08d6dbfe8c612fc7)), closes [#3002](https://github.com/joeyparrish/shaka-player/issues/3002)
* Export LanguageUtils ([5783694](https://github.com/joeyparrish/shaka-player/commit/57836942c6e5bc93d37dd9ee6342ac586150f844)), closes [#3692](https://github.com/joeyparrish/shaka-player/issues/3692)
...
* **HLS:** Containerless format support ([36d0b54](https://github.com/joeyparrish/shaka-player/commit/36d0b5484fad68dc1d640fbddf2fae3e1eb7169b)), closes [#2337](https://github.com/joeyparrish/shaka-player/issues/2337)
...
* **hls:** Make default HLS audio/video codecs configurable ([#3651](https://github.com/joeyparrish/shaka-player/issues/3651)) ([52d68a2](https://github.com/joeyparrish/shaka-player/commit/52d68a29c86ec5696bfaf36abb5ba055f29180f8))
...
* **ll-hls:** only request delta updates when server supports it ([4c97562](https://github.com/joeyparrish/shaka-player/commit/4c975621a0110a7e6d21be2b8e2cebeb80e1cb1c)), closes [#1525](https://github.com/joeyparrish/shaka-player/issues/1525)
* make drm sessionType configurable in advanced DRM config ([#3301](https://github.com/joeyparrish/shaka-player/issues/3301)) ([4574a5d](https://github.com/joeyparrish/shaka-player/commit/4574a5dd929bb6cf94cf89663b8f870c5ffc74bd))
* Make gap detection threshold configurable ([#3166](https://github.com/joeyparrish/shaka-player/issues/3166)) ([d36936b](https://github.com/joeyparrish/shaka-player/commit/d36936bef8ef2156cb80529a27ab59021af1af37))
...
* **MediaCap:** Add config for using MediaCapabilities ([129b068](https://github.com/joeyparrish/shaka-player/commit/129b0683857716847ca429cf4283dbdc2ca3931f)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **MediaCap:** Add MediaCap polyfill to uncompiled.js ([8912792](https://github.com/joeyparrish/shaka-player/commit/891279272ddaa8344126f428a66d4505a602c669)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **MediaCap:** Add polyfill for MediaCapabilities ([f4c6063](https://github.com/joeyparrish/shaka-player/commit/f4c6063b82207a28bd975f73fefc644f9734a468)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **MediaCap:** Add preferredDecodingAttributes config ([79d5fd8](https://github.com/joeyparrish/shaka-player/commit/79d5fd8ca0a7c5f3738d539aec226395dc10b83e)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **MediaCap:** Always polyfill MediaCap for Chromecast ([e592d48](https://github.com/joeyparrish/shaka-player/commit/e592d4888e35af0e0c98bc2f85c4e51f681948e8)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **MediaCap:** Check spatialRendering against MediaCapabilities ([#3224](https://github.com/joeyparrish/shaka-player/issues/3224)) ([b84f774](https://github.com/joeyparrish/shaka-player/commit/b84f7742c05c7362579eb7b94f6d3b94b357c0dc))
* **MediaCap:** Default "useMediaCapablities" to true ([bd7e07b](https://github.com/joeyparrish/shaka-player/commit/bd7e07b074f66492f025f7c7a386a80c16ab6f84))
* **MediaCap:** get decodingInfo results before queryMediaKeys ([acfa1a8](https://github.com/joeyparrish/shaka-player/commit/acfa1a800c5cd731afcea191be45169037f8784b)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **MediaCap:** get mediaKeySystemAccess via decodingInfo ([aca343b](https://github.com/joeyparrish/shaka-player/commit/aca343bf2c55c7e17dc744b1bf675186b8cb3380)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **MediaCap:** Guess the codecs of multiplexd stream for MediaCap ([198a6d4](https://github.com/joeyparrish/shaka-player/commit/198a6d42f6efb29bcf763273d66a17834b3acc6f)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **MediaCap:** Patch VP9 codec ([bf0644a](https://github.com/joeyparrish/shaka-player/commit/bf0644aa4a0da1ee4b0d5b75028a17bcf6d86d60))
* **MediaCap:** Skip filtering by DrmEngine with MediaCap enabled ([0f0c940](https://github.com/joeyparrish/shaka-player/commit/0f0c9409c3f10848eec7a2626142e747528ba76e)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391) [#3334](https://github.com/joeyparrish/shaka-player/issues/3334)
* **MediaCap:** Support multiplex content with MediaCap ([966a756](https://github.com/joeyparrish/shaka-player/commit/966a7565785136395cd8121b296ee7aa5a2a2511)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **MediaCap:** Use MediaCapabilities for offline storage ([2f65b97](https://github.com/joeyparrish/shaka-player/commit/2f65b97b79c9b9dfde1b95afadf7c790827054c7)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **MediaCap:** Use MediaCapabilities for supporting info ([57ee238](https://github.com/joeyparrish/shaka-player/commit/57ee23812e936bf6fa3e77830c1f1e7aeb7e1cd1)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **MediaCap:** Use mediaKeySystemAccess from decodingInfo in DrmEngine ([b63a64e](https://github.com/joeyparrish/shaka-player/commit/b63a64e4ba83f7db422853dc879d1068e5f6dcdb)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **net:** Add response HTTP status to Networking engine responses ([#3641](https://github.com/joeyparrish/shaka-player/issues/3641)) ([2701527](https://github.com/joeyparrish/shaka-player/commit/27015278cd905631c9c4edbc164c8639f5d90c61)), closes [#3640](https://github.com/joeyparrish/shaka-player/issues/3640)
* Network stall detection ([#3227](https://github.com/joeyparrish/shaka-player/issues/3227)) ([863e345](https://github.com/joeyparrish/shaka-player/commit/863e3455b68657cc73960022876c657498362ee5)), closes [#1582](https://github.com/joeyparrish/shaka-player/issues/1582)
...
* **offline:** Changed store order of operations. ([5215f53](https://github.com/joeyparrish/shaka-player/commit/5215f5319fef03b2b4881845dd50a06f1c4be8af)), closes [#879](https://github.com/joeyparrish/shaka-player/issues/879)
...
* **offline:** Load init segments first for keys ([db8ad31](https://github.com/joeyparrish/shaka-player/commit/db8ad31bfbe1c2b9a372daad893d900e77d5e484)), closes [#879](https://github.com/joeyparrish/shaka-player/issues/879)
* **offline:** Make segment storage stateless. ([aded252](https://github.com/joeyparrish/shaka-player/commit/aded252e40445f4c65565932fb400b35d9a18e59)), closes [#879](https://github.com/joeyparrish/shaka-player/issues/879)
...
* **player:** Add updateStartTime method to play ([#3491](https://github.com/joeyparrish/shaka-player/issues/3491)) ([16c1810](https://github.com/joeyparrish/shaka-player/commit/16c1810b0321724b0daa44cf7f4736b0b0983153))
* **player:** Added events for download lifecycle. ([7893b77](https://github.com/joeyparrish/shaka-player/commit/7893b7733b7190e820dea28c6ea1bb4629ca1d88)), closes [#3533](https://github.com/joeyparrish/shaka-player/issues/3533)
...
* Progress toward FairPlay DRM w/ MSE ([#3347](https://github.com/joeyparrish/shaka-player/issues/3347)) ([46b1cfa](https://github.com/joeyparrish/shaka-player/commit/46b1cfa552ba860cbce80f3b9e26acf337589793))
...
* Support frequent updates during streaming ([#3483](https://github.com/joeyparrish/shaka-player/issues/3483)) ([6e69bed](https://github.com/joeyparrish/shaka-player/commit/6e69bed0160fcf61c8f42d7600147824e8453299)), closes [#3332](https://github.com/joeyparrish/shaka-player/issues/3332)
...
* **text:** Creates style tags for underline/italics/bold in WebVttGenerator ([#3266](https://github.com/joeyparrish/shaka-player/issues/3266)) ([658790a](https://github.com/joeyparrish/shaka-player/commit/658790a012e9aa77790b125acb9797f9b40518cf))
* **text:** Partially support tts:textOutline ([911ce6d](https://github.com/joeyparrish/shaka-player/commit/911ce6d25037bdc3981cbeda93f74e596acafc0f)), closes [#3612](https://github.com/joeyparrish/shaka-player/issues/3612)
* **thumbnails:** Allow download thumbnails (for offline usage) ([#3280](https://github.com/joeyparrish/shaka-player/issues/3280)) ([06982de](https://github.com/joeyparrish/shaka-player/commit/06982defa0d278a9bb870ed18fbba02db88cf687))
...
* **ui:** Add configurable rates ([#3579](https://github.com/joeyparrish/shaka-player/issues/3579)) ([f65b093](https://github.com/joeyparrish/shaka-player/commit/f65b093d40f1c1f0d4e5e8e47fcc128ff3ca74ea)), closes [#3443](https://github.com/joeyparrish/shaka-player/issues/3443)
* **ui:** Add Loop, PIP, Cast, AirPlay buttons to control panel ([#3255](https://github.com/joeyparrish/shaka-player/issues/3255)) ([4f0ded7](https://github.com/joeyparrish/shaka-player/commit/4f0ded7e379784f97acae7466c2fd434ec806141)), closes [#2676](https://github.com/joeyparrish/shaka-player/issues/2676)
...
* **ui:** Add Quality, Language, Playback, Captions buttons to control panel ([#3465](https://github.com/joeyparrish/shaka-player/issues/3465)) ([481b378](https://github.com/joeyparrish/shaka-player/commit/481b378a4bb249fb13c6a2f9916e38c859fcbe3f))
* **ui:** Add right-click context menu, statistics button ([#3548](https://github.com/joeyparrish/shaka-player/issues/3548)) ([afb9310](https://github.com/joeyparrish/shaka-player/commit/afb93106a71ce0868edba3159a84e889ee0694ad)), closes [#2607](https://github.com/joeyparrish/shaka-player/issues/2607)
* **ui:** Add tooltips to control panel buttons ([#3572](https://github.com/joeyparrish/shaka-player/issues/3572)) ([d5769ee](https://github.com/joeyparrish/shaka-player/commit/d5769eeda47524998a714a3d701604561d761b6d)), closes [#3269](https://github.com/joeyparrish/shaka-player/issues/3269)
* **UI:** Add video fullscreen support for iOS ([#3853](https://github.com/joeyparrish/shaka-player/issues/3853)) ([8d1b5e6](https://github.com/joeyparrish/shaka-player/commit/8d1b5e6b07e979bd641da0b2b53c5f8e872422ad)), closes [#3832](https://github.com/joeyparrish/shaka-player/issues/3832)
* **ui:** Added Loop and PIP to context menu, and Statistics to overflow menu ([#3578](https://github.com/joeyparrish/shaka-player/issues/3578)) ([34958c8](https://github.com/joeyparrish/shaka-player/commit/34958c81b934bb3d6c9bb4f671be7305430ff9ab))
* **UI:** Adds singleClickForPlayAndPause config ([8aacdcf](https://github.com/joeyparrish/shaka-player/commit/8aacdcf76ca80f5927205995584fb9e8d1cf774d)), closes [#3821](https://github.com/joeyparrish/shaka-player/issues/3821)
* **UI:** Display cursors as pointers on overflow menu buttons([#3218](https://github.com/joeyparrish/shaka-player/issues/3218)) ([9fb637d](https://github.com/joeyparrish/shaka-player/commit/9fb637d82f3374c06bfd0498a85a290889551e7a))
* **UI:** Exit PiP when destroying UI ([38cfc23](https://github.com/joeyparrish/shaka-player/commit/38cfc230483133862cc41153931f4dc170eb4a75)), closes [#3553](https://github.com/joeyparrish/shaka-player/issues/3553)


### Bug Fixes

* 3783 captions not working after a period transition on live DASH streams ([#3801](https://github.com/joeyparrish/shaka-player/issues/3801)) ([6e0737e](https://github.com/joeyparrish/shaka-player/commit/6e0737ec25c14a1566cbb1dd8662ed6abf527670)), closes [#3783](https://github.com/joeyparrish/shaka-player/issues/3783)
* Account for server-side ad cue points in external text tracks. ([#3617](https://github.com/joeyparrish/shaka-player/issues/3617)) ([a7f4db7](https://github.com/joeyparrish/shaka-player/commit/a7f4db7f185a77424db1283ec51af742cddf97cf))
* Add DASH MIME type mapping for src= playback ([#3805](https://github.com/joeyparrish/shaka-player/issues/3805)) ([3a9139e](https://github.com/joeyparrish/shaka-player/commit/3a9139e21274708ac56c9b1175892db54e25be73))
* Add explicit release() for FakeEventTarget ([#3950](https://github.com/joeyparrish/shaka-player/issues/3950)) ([f1c1585](https://github.com/joeyparrish/shaka-player/commit/f1c1585afb2cfa3eb6b7465c8b32c9bad8e62d15))
...
* Add support to file type in mediaCapabilities implementation ([#3570](https://github.com/joeyparrish/shaka-player/issues/3570)) ([233c2bf](https://github.com/joeyparrish/shaka-player/commit/233c2bf4d8f1f73401d33dddb38e214ebda449e6)), closes [#3530](https://github.com/joeyparrish/shaka-player/issues/3530)
* Add support to file type in MediaCapabilities polyfill ([#3569](https://github.com/joeyparrish/shaka-player/issues/3569)) ([c07d1a3](https://github.com/joeyparrish/shaka-player/commit/c07d1a3e09a2856a6738357b1dff1b16eead8c0c)), closes [#3530](https://github.com/joeyparrish/shaka-player/issues/3530)
* Add Support to iOS 12 in MediaCapabilities polyfill ([#3573](https://github.com/joeyparrish/shaka-player/issues/3573)) ([ef506ac](https://github.com/joeyparrish/shaka-player/commit/ef506ac647cc6134a8b187fe82824eaa065f8bb7))
* **ads:** Add ResizeObserver to CS ad manager. ([#3652](https://github.com/joeyparrish/shaka-player/issues/3652)) ([2bdc326](https://github.com/joeyparrish/shaka-player/commit/2bdc326ed648df4855faf6a0add815356cdeab7e)), closes [#3638](https://github.com/joeyparrish/shaka-player/issues/3638)
* **ads:** Add the original IMA event to the Shaka AD_CLICKED event. ([7c6ee2d](https://github.com/joeyparrish/shaka-player/commit/7c6ee2d47006cf6e6ab895a9880b73d935f996c4)), closes [#3304](https://github.com/joeyparrish/shaka-player/issues/3304)
* **ads:** Dispose of ad manager on player detach ([7b2a172](https://github.com/joeyparrish/shaka-player/commit/7b2a17276b495c7961fac1fdcbf944b613c542d1))
* **ads:** Fix stopping of Server Side Ad manager ([#3611](https://github.com/joeyparrish/shaka-player/issues/3611)) ([a17c988](https://github.com/joeyparrish/shaka-player/commit/a17c98800415bec92ce3c8d2e352c4e363e0050c))
* **ads:** Fix the skip ad button not being clickable [#3284](https://github.com/joeyparrish/shaka-player/issues/3284) ([#3326](https://github.com/joeyparrish/shaka-player/issues/3326)) ([78e181d](https://github.com/joeyparrish/shaka-player/commit/78e181db38875d360de3fd5ad76e82821b50e843))
* **ads:** Hide the ad container when ads aren't playing. ([23fe712](https://github.com/joeyparrish/shaka-player/commit/23fe7128494d0678d6fd8e3bc951f303907ec5cf)), closes [#3121](https://github.com/joeyparrish/shaka-player/issues/3121)
* Allow muxjs to be loaded after Shaka ([65a2cfd](https://github.com/joeyparrish/shaka-player/commit/65a2cfdda98b913c6f5b802a299cabd7477f3d49)), closes [#3407](https://github.com/joeyparrish/shaka-player/issues/3407)
* Always polyfill MediaCapabilities for Apple browsers ([#3588](https://github.com/joeyparrish/shaka-player/issues/3588)) ([4dce1e0](https://github.com/joeyparrish/shaka-player/commit/4dce1e0ba5988e21dbf70490ae32819fe6433632))
* Avoid seeking on src when start time is 0 ([#3644](https://github.com/joeyparrish/shaka-player/issues/3644)) ([3f822d8](https://github.com/joeyparrish/shaka-player/commit/3f822d81221ff7c4d2ee2487b0eca5c4791d7059)), closes [#3518](https://github.com/joeyparrish/shaka-player/issues/3518)
* Avoid setting global Cast hook ([ecbeae0](https://github.com/joeyparrish/shaka-player/commit/ecbeae0ecbcc28a4e9ac8627883656a05a90b1b3)), closes [#3167](https://github.com/joeyparrish/shaka-player/issues/3167)
* Avoid WebCrypto randomUUID when CMCD disabled ([4731c76](https://github.com/joeyparrish/shaka-player/commit/4731c7677f4f179f19ae647d3bb1edfda40dac53))
* **build:** Fix stylelint on Windows ([#3214](https://github.com/joeyparrish/shaka-player/issues/3214)) ([568321c](https://github.com/joeyparrish/shaka-player/commit/568321c2d147962dab29195466fc17756a2b452f)), closes [#2985](https://github.com/joeyparrish/shaka-player/issues/2985)
* **cast:** Make cast tests more forgiving. ([4fee1de](https://github.com/joeyparrish/shaka-player/commit/4fee1de967e782e532e0ddd791df0bcca14c557c))
* **cea:** Fix BUFFER_READ_OUT_OF_BOUNDS error when CEA caption packets are empty ([#3609](https://github.com/joeyparrish/shaka-player/issues/3609)) ([97ba4df](https://github.com/joeyparrish/shaka-player/commit/97ba4dfd7bdcbf1b612af3679ee85273a1967715)), closes [#3608](https://github.com/joeyparrish/shaka-player/issues/3608)
...
* choose the configured preferred text role at start ([#3399](https://github.com/joeyparrish/shaka-player/issues/3399)) ([d47c823](https://github.com/joeyparrish/shaka-player/commit/d47c823afab404f0ef4a6269086c88c89efedcc1))
* Clear buffer on seek if mediaState is updating ([#3795](https://github.com/joeyparrish/shaka-player/issues/3795)) ([9705639](https://github.com/joeyparrish/shaka-player/commit/9705639f4514d8d2dbfe5d81a31388f99e6be507)), closes [#3299](https://github.com/joeyparrish/shaka-player/issues/3299)
...
* **dash:** Fix stalls on a live dash stream. ([7e50866](https://github.com/joeyparrish/shaka-player/commit/7e50866bb539ddd7e70ed6d6c245793b353262a6))
* **dash:** Notify segments on all updates. ([b8b72a9](https://github.com/joeyparrish/shaka-player/commit/b8b72a900d155ef085e72e62b5da697d67990c04)), closes [#3675](https://github.com/joeyparrish/shaka-player/issues/3675)
* **DASH:** Support "forced-subtitle" role ([#3807](https://github.com/joeyparrish/shaka-player/issues/3807)) ([f767260](https://github.com/joeyparrish/shaka-player/commit/f767260dcc96787b2ceda7548ddd95210e8130e2)), closes [#3767](https://github.com/joeyparrish/shaka-player/issues/3767)
* Dedupe DRM init data ([#3695](https://github.com/joeyparrish/shaka-player/issues/3695)) ([a09d8c9](https://github.com/joeyparrish/shaka-player/commit/a09d8c9869d5246af540d562f36546a294c2d9e9))
* **demo:** Fix 'Tears of Steel (live, DASH, Server Side ads)' ([#3758](https://github.com/joeyparrish/shaka-player/issues/3758)) ([fb90679](https://github.com/joeyparrish/shaka-player/commit/fb906798199d10f6deb5b0406d6248d57a781c83))
* **demo:** Fix centering of icons, add hover effect on settings ([#3352](https://github.com/joeyparrish/shaka-player/issues/3352)) ([ef0c651](https://github.com/joeyparrish/shaka-player/commit/ef0c651ac04f9e8218cab16e1b261a7685264713))
* Discard only invalid overlapping periods ([1c64e20](https://github.com/joeyparrish/shaka-player/commit/1c64e209097714e88956f4053d037dc7060813b9))
* Discard only invalid periods ([94d696f](https://github.com/joeyparrish/shaka-player/commit/94d696fd042c39450712f87c02735e8faa49138a))
* Display captions with forward slashes ([#3556](https://github.com/joeyparrish/shaka-player/issues/3556)) ([65e9d8f](https://github.com/joeyparrish/shaka-player/commit/65e9d8ff85815d9f3226a8df091053d747be7294))
...
* **docs:** corrects typo in project README ([#3368](https://github.com/joeyparrish/shaka-player/issues/3368)) ([3404805](https://github.com/joeyparrish/shaka-player/commit/340480525d6949d6a76fab7b0b4b26aae7ea30fa))
* **doc:** Update [@event](https://github.com/event) and [@link](https://github.com/link) in UI ([99314b7](https://github.com/joeyparrish/shaka-player/commit/99314b733f74922e525b79be8af6bc70b6841ae0))
* Don't destroy ad manager on detach ([#3665](https://github.com/joeyparrish/shaka-player/issues/3665)) ([684dd85](https://github.com/joeyparrish/shaka-player/commit/684dd852164ce94bfdf85d0d8ab2cc1390cdbeba))
* Don't force update captions by default ([#3425](https://github.com/joeyparrish/shaka-player/issues/3425)) ([a0d3e52](https://github.com/joeyparrish/shaka-player/commit/a0d3e528de04f1b0fe5a33ffcb7844e1414f1b5e))
* Don't forget active track after new period is added to live stream. ([22307d0](https://github.com/joeyparrish/shaka-player/commit/22307d0ac11c005a7686616365100df01a5ec407)), closes [#3510](https://github.com/joeyparrish/shaka-player/issues/3510)
* Don't gap jump at start of video if autoplay is not set ([#3645](https://github.com/joeyparrish/shaka-player/issues/3645)) ([9e15323](https://github.com/joeyparrish/shaka-player/commit/9e153231e7fb021185bfeb6ce123a3992625a9f2)), closes [#3451](https://github.com/joeyparrish/shaka-player/issues/3451)
* Enforce string-format of event data keys. ([dd3748d](https://github.com/joeyparrish/shaka-player/commit/dd3748d59970de46255cd6d8b4204ee501600655)), closes [#3710](https://github.com/joeyparrish/shaka-player/issues/3710)
* Enhanced fix for geo-redundancy ([5f77d2b](https://github.com/joeyparrish/shaka-player/commit/5f77d2b8f19787ccdf8639ad0a8991824788247f))
* Exported SegmentReference.getUris. ([8e1eeda](https://github.com/joeyparrish/shaka-player/commit/8e1eeda96516b43b91cf240eb20ca486958b6fe3)), closes [#3096](https://github.com/joeyparrish/shaka-player/issues/3096)
* Failover in geo-redundant streams ([930c158](https://github.com/joeyparrish/shaka-player/commit/930c158629d352b1e5186b5ad0eeb370e95c7aaa))
* FairPlay playback ([#3531](https://github.com/joeyparrish/shaka-player/issues/3531)) ([3995000](https://github.com/joeyparrish/shaka-player/commit/3995000abcbb29e3b1228397868e13e6c34e34a7))
* Filter unsupported H.264 streams in Xbox ([#3411](https://github.com/joeyparrish/shaka-player/issues/3411)) ([a096bc1](https://github.com/joeyparrish/shaka-player/commit/a096bc1452d48c8cbcc250b960d7bd8f79f1a83a))
* Fix ARIA label on replay button ([#3513](https://github.com/joeyparrish/shaka-player/issues/3513)) ([2dedd9f](https://github.com/joeyparrish/shaka-player/commit/2dedd9f3f5c10b4265c2264b4f6ea6573aeabc4f)), closes [#3512](https://github.com/joeyparrish/shaka-player/issues/3512)
* Fix audio language switching while using AirPlay ([#3472](https://github.com/joeyparrish/shaka-player/issues/3472)) ([f9c289e](https://github.com/joeyparrish/shaka-player/commit/f9c289efd1086417d33f515ef481113fe36ce662)), closes [#3125](https://github.com/joeyparrish/shaka-player/issues/3125)
...
* Fix buffering due to re-fetch (SegmentIterator) ([#3419](https://github.com/joeyparrish/shaka-player/issues/3419)) ([9e6da5a](https://github.com/joeyparrish/shaka-player/commit/9e6da5a6e96234fa99b96e3931774781d11e2ac8))
* Fix buffering due to re-fetch (SegmentTemplate+duration) ([#3419](https://github.com/joeyparrish/shaka-player/issues/3419)) ([9dc4664](https://github.com/joeyparrish/shaka-player/commit/9dc466475a857041aa485ac7a804aae9de9c63c1))
* Fix buffering due to re-fetch (SegmentTimeline) ([3222370](https://github.com/joeyparrish/shaka-player/commit/3222370674d868d121ffec2e0a1fc4e978c2e005))
* Fix CC parsing of EPB and v1 TKHD boxes ([#3610](https://github.com/joeyparrish/shaka-player/issues/3610)) ([6a775e2](https://github.com/joeyparrish/shaka-player/commit/6a775e29a4c96588822288188d8e34ea4c992713)), closes [#3502](https://github.com/joeyparrish/shaka-player/issues/3502)
* Fix choosing tracks from streaming event ([#3459](https://github.com/joeyparrish/shaka-player/issues/3459)) ([760161f](https://github.com/joeyparrish/shaka-player/commit/760161f6ddf809da82c762956080fab7eb73f489)), closes [#3448](https://github.com/joeyparrish/shaka-player/issues/3448)
* Fix clearing buffer when requested for already-selected variant ([#3477](https://github.com/joeyparrish/shaka-player/issues/3477)) ([e85009d](https://github.com/joeyparrish/shaka-player/commit/e85009de325c9da803df90ed37f9ef9c70788fc8)), closes [#3450](https://github.com/joeyparrish/shaka-player/issues/3450)
* Fix CMCD property mangling ([#3842](https://github.com/joeyparrish/shaka-player/issues/3842)) ([fa5932c](https://github.com/joeyparrish/shaka-player/commit/fa5932ca8f604952590734bf8bdc27ad8e69e8d8)), closes [#3839](https://github.com/joeyparrish/shaka-player/issues/3839)
* Fix CMCD top bitrate reporting ([#3852](https://github.com/joeyparrish/shaka-player/issues/3852)) ([922778a](https://github.com/joeyparrish/shaka-player/commit/922778a5ebd2d58ca0c1e804745ca40cda1228bc)), closes [#3851](https://github.com/joeyparrish/shaka-player/issues/3851)
* Fix compilation error with strict constness ([6757d23](https://github.com/joeyparrish/shaka-player/commit/6757d238d0a0cd29b3933b31bf43c0f6adbf17ac))
* Fix compiler error introduced in [#3864](https://github.com/joeyparrish/shaka-player/issues/3864) ([#3906](https://github.com/joeyparrish/shaka-player/issues/3906)) ([0635e2c](https://github.com/joeyparrish/shaka-player/commit/0635e2c055c13a405048c7696389c1dfc039902f))
* Fix DASH transition from dynamic to static ([#3497](https://github.com/joeyparrish/shaka-player/issues/3497)) ([b3166db](https://github.com/joeyparrish/shaka-player/commit/b3166db4bc7cac968a03796bc9c2d7e598fb88c7)), closes [#3376](https://github.com/joeyparrish/shaka-player/issues/3376)
* Fix download of some HLS assets ([#3934](https://github.com/joeyparrish/shaka-player/issues/3934)) ([36ca820](https://github.com/joeyparrish/shaka-player/commit/36ca820877965db8bcc8b9c4b2a428317301bb95))
* Fix DRM workaround for Tizen and Xbox with ac-3 boxes ([#3631](https://github.com/joeyparrish/shaka-player/issues/3631)) ([56a0042](https://github.com/joeyparrish/shaka-player/commit/56a004209ceb259794840bcba6a535ecd1c04c69)), closes [#3589](https://github.com/joeyparrish/shaka-player/issues/3589)
* Fix DRM workaround for Tizen and Xbox with avc3 boxes ([#3625](https://github.com/joeyparrish/shaka-player/issues/3625)) ([31b1ca9](https://github.com/joeyparrish/shaka-player/commit/31b1ca9f8104d3920f75b918a4f2fc6889f1e3bf))
* Fix duplicate CMCD parameters in HLS live content ([#3875](https://github.com/joeyparrish/shaka-player/issues/3875)) ([f27401c](https://github.com/joeyparrish/shaka-player/commit/f27401cc151a435ae8fb12be4e86d672c331e1e5)), closes [#3862](https://github.com/joeyparrish/shaka-player/issues/3862)
* Fix EC-3 box support in DRM workaround on smart TVs ([#3427](https://github.com/joeyparrish/shaka-player/issues/3427)) ([87786f4](https://github.com/joeyparrish/shaka-player/commit/87786f4df6fd172dcc6cb996b947104f646d9af2))
...
* Fix enforcement of cue alignment styles ([2250324](https://github.com/joeyparrish/shaka-player/commit/2250324a4acd039e3d86ce59178d476cadaa3aef)), closes [#3379](https://github.com/joeyparrish/shaka-player/issues/3379)
* Fix exception in StreamingEngine for EMSG with HLS ([#3887](https://github.com/joeyparrish/shaka-player/issues/3887)) ([48433ab](https://github.com/joeyparrish/shaka-player/commit/48433abe74c5f603cf06097e391ffdfa22d64256)), closes [#3886](https://github.com/joeyparrish/shaka-player/issues/3886)
...
* Fix failed assertion for eviction logic ([29e7ab1](https://github.com/joeyparrish/shaka-player/commit/29e7ab19d998e86e5466b296566bacca79989c6d)), closes [#3169](https://github.com/joeyparrish/shaka-player/issues/3169)
* Fix failure with multiple thumbnails per period ([052e794](https://github.com/joeyparrish/shaka-player/commit/052e7943b191973776aeab899ac97a21b09dc819)), closes [#3383](https://github.com/joeyparrish/shaka-player/issues/3383)
* Fix filtering of duplicate image streams ([42674be](https://github.com/joeyparrish/shaka-player/commit/42674bee038eb1b0881dd7f0303944a043186103)), closes [#3383](https://github.com/joeyparrish/shaka-player/issues/3383)
* Fix hung playback on rapid seek ([#3479](https://github.com/joeyparrish/shaka-player/issues/3479)) ([f7facc0](https://github.com/joeyparrish/shaka-player/commit/f7facc043ec983de10e9f90e56ccb33ff5176903)), closes [#3384](https://github.com/joeyparrish/shaka-player/issues/3384)
* Fix key rotation in DASH ([6143a6d](https://github.com/joeyparrish/shaka-player/commit/6143a6d31465c7715be452fa6c60f770aeb474c5)), closes [#3169](https://github.com/joeyparrish/shaka-player/issues/3169)
* Fix mediaCapabilities polyfill on Chromecast ([de77787](https://github.com/joeyparrish/shaka-player/commit/de777872193d2ebf35559471ec72e9a87b0b8e6e))
* Fix MediaCapabilities polyfill on Safari ([0201f2b](https://github.com/joeyparrish/shaka-player/commit/0201f2b7604e76062b68b8b1acbf098faf71d019)), closes [#3696](https://github.com/joeyparrish/shaka-player/issues/3696) [#3530](https://github.com/joeyparrish/shaka-player/issues/3530)
* Fix memory leak in DASH live streams with inband EventStream ([#3957](https://github.com/joeyparrish/shaka-player/issues/3957)) ([b7f04cb](https://github.com/joeyparrish/shaka-player/commit/b7f04cb36bda664ec9cf23a081d237793907eaae))
* Fix misdetection of HEVC support on MS Edge ([#3897](https://github.com/joeyparrish/shaka-player/issues/3897)) ([dfb3699](https://github.com/joeyparrish/shaka-player/commit/dfb369935b9e84fe69a7d38c7904fb0e00dc064a)), closes [#3860](https://github.com/joeyparrish/shaka-player/issues/3860)
* Fix missing override in MetaSegmentIndex ([1dbd75a](https://github.com/joeyparrish/shaka-player/commit/1dbd75ad7dae99cd5d315139291d29fae85a0781))
* Fix missing throughput in CMCD for HLS live ([#3874](https://github.com/joeyparrish/shaka-player/issues/3874)) ([df55944](https://github.com/joeyparrish/shaka-player/commit/df55944e8f49bdf8e34a679219cd6596ba46c777)), closes [#3873](https://github.com/joeyparrish/shaka-player/issues/3873)
* Fix multiperiod without consistent thumbnails ([ed1563f](https://github.com/joeyparrish/shaka-player/commit/ed1563f70df889fb1c57f45cd2ec01d579e565cf)), closes [#3383](https://github.com/joeyparrish/shaka-player/issues/3383)
* Fix new method missing from cast proxy ([0a62396](https://github.com/joeyparrish/shaka-player/commit/0a62396ae4f1470c2af76db8b9be488a0602e964)), closes [#3392](https://github.com/joeyparrish/shaka-player/issues/3392) [#3389](https://github.com/joeyparrish/shaka-player/issues/3389)
* Fix playback failure due to rounding errors ([1cc99c1](https://github.com/joeyparrish/shaka-player/commit/1cc99c1241c89b5fb5a989dd52ff0b9a9753b65f)), closes [#3717](https://github.com/joeyparrish/shaka-player/issues/3717)
...
* Fix rapid keyboard-based seeking ([77054d2](https://github.com/joeyparrish/shaka-player/commit/77054d2177d3a2716481c8b73f2a821944e5230f)), closes [#3234](https://github.com/joeyparrish/shaka-player/issues/3234)
* fix reference searching when search time = segment.endTime ([01ce0f4](https://github.com/joeyparrish/shaka-player/commit/01ce0f4b76f360db86e2a375f10af5f34509885d)), closes [#3191](https://github.com/joeyparrish/shaka-player/issues/3191)
* Fix STORAGE_LIMIT_REACHED error masked by DOWNLOAD_SIZE_CALLBACK_ERROR ([#3396](https://github.com/joeyparrish/shaka-player/issues/3396)) ([69c310c](https://github.com/joeyparrish/shaka-player/commit/69c310cefd2833285b459afc7f3cc026f8226f2a))
* Fix support for TTAF1 namespace (old version of TTML) ([#3864](https://github.com/joeyparrish/shaka-player/issues/3864)) ([771619f](https://github.com/joeyparrish/shaka-player/commit/771619ff0ef8ba0e3da9569ded3894b428d03c58)), closes [#3009](https://github.com/joeyparrish/shaka-player/issues/3009)
* Fix thumbnail duration, expose start time and duration ([d4a1255](https://github.com/joeyparrish/shaka-player/commit/d4a1255235e174d8a0ca6ca3a8edb5b10db59405)), closes [#3517](https://github.com/joeyparrish/shaka-player/issues/3517)
* Fix thumbnail position calculation ([#3516](https://github.com/joeyparrish/shaka-player/issues/3516)) ([097c9a1](https://github.com/joeyparrish/shaka-player/commit/097c9a1cc4d17be4e583ceee185eab0ab7b02c97)), closes [#3511](https://github.com/joeyparrish/shaka-player/issues/3511)
* Fix tracking of pressed keys in the UI ([#3259](https://github.com/joeyparrish/shaka-player/issues/3259)) ([0943c80](https://github.com/joeyparrish/shaka-player/commit/0943c80ce8098ad04ae3546454bdb63c1fee560a))
* Fix TTML background image attribute case ([43538fb](https://github.com/joeyparrish/shaka-player/commit/43538fba43284d400e8e538134cb4f8b099feb76)), closes [#3196](https://github.com/joeyparrish/shaka-player/issues/3196)
* Fix usage of Shaka without polyfills ([dfc44cb](https://github.com/joeyparrish/shaka-player/commit/dfc44cbca6b95eb137882075cb8bf02cfc73a9d3))
* Fix v1 emsg box start/end times ([#3198](https://github.com/joeyparrish/shaka-player/issues/3198)) ([fc3afeb](https://github.com/joeyparrish/shaka-player/commit/fc3afeb267099c535749275f5545ef1ac1ca67f9))
* Fix vp09 playback on webOS ([#3566](https://github.com/joeyparrish/shaka-player/issues/3566)) ([13aafcf](https://github.com/joeyparrish/shaka-player/commit/13aafcfd7e5016244b78bb3738d471ffb48193d4))
...
* Fixed Pull Request template folder directory ([#3207](https://github.com/joeyparrish/shaka-player/issues/3207)) ([2222c06](https://github.com/joeyparrish/shaka-player/commit/2222c06795ee5d6defcf6cc887b34b09e766a2ac))
* Fixed windows build error ([#3211](https://github.com/joeyparrish/shaka-player/issues/3211)) ([ee14514](https://github.com/joeyparrish/shaka-player/commit/ee14514929e77e612d68facfbf4b41804cc81888)), closes [#3208](https://github.com/joeyparrish/shaka-player/issues/3208) [#3204](https://github.com/joeyparrish/shaka-player/issues/3204)
* Fixes bug in trick mode stream concatenation ([f091084](https://github.com/joeyparrish/shaka-player/commit/f0910842116157d71b10cd737d5f9f99354d5670)), closes [#3423](https://github.com/joeyparrish/shaka-player/issues/3423)
* Fixes updating of nested cues ([b02ff27](https://github.com/joeyparrish/shaka-player/commit/b02ff27017db362bb6562fdd2ac14cdf27005cb2)), closes [#3524](https://github.com/joeyparrish/shaka-player/issues/3524) [#3643](https://github.com/joeyparrish/shaka-player/issues/3643)
* Force update captions when element resizes ([#3426](https://github.com/joeyparrish/shaka-player/issues/3426)) ([a09fa31](https://github.com/joeyparrish/shaka-player/commit/a09fa311888db5735b2f62b2d112a07058e73ffb))
* Force update captions with fullscreen ([#3414](https://github.com/joeyparrish/shaka-player/issues/3414)) ([b426fe8](https://github.com/joeyparrish/shaka-player/commit/b426fe87f8f00c54988a23bafe05c0e27898d776))
* **hls:** Assume MP4 if MIME type can't be deduced ([#3325](https://github.com/joeyparrish/shaka-player/issues/3325)) ([7714099](https://github.com/joeyparrish/shaka-player/commit/77140991f10885b0169495c29300ea35b04ad511)), closes [#3142](https://github.com/joeyparrish/shaka-player/issues/3142)
...
* **hls:** Fix content type detection when text codec are present. ([9cca82b](https://github.com/joeyparrish/shaka-player/commit/9cca82bfd092dffbbb4cb5f0d2948831ab7d97cf)), closes [#3184](https://github.com/joeyparrish/shaka-player/issues/3184)
...
* **hls:** Fixes parsing of HLS 'DEFAULT' attribute ([#3771](https://github.com/joeyparrish/shaka-player/issues/3771)) ([3e7a5b5](https://github.com/joeyparrish/shaka-player/commit/3e7a5b5f872011b575e14f8a68d21af0a88e822b)), closes [#3769](https://github.com/joeyparrish/shaka-player/issues/3769)
* **hls:** Made HLS notify segments after fit ([1e598ba](https://github.com/joeyparrish/shaka-player/commit/1e598bab652dbca32aae49f43f5354d5788e1698)), closes [#3733](https://github.com/joeyparrish/shaka-player/issues/3733)
* **hls:** Made HLS notify segments after fit ([9220c1f](https://github.com/joeyparrish/shaka-player/commit/9220c1f87d3ab1b23d0008fc8b0164d2ad26f35f)), closes [#3733](https://github.com/joeyparrish/shaka-player/issues/3733)
* **HLS:** Prioritize AVERAGE-BANDWIDTH over BANDWIDTH ([#3428](https://github.com/joeyparrish/shaka-player/issues/3428)) ([76480f9](https://github.com/joeyparrish/shaka-player/commit/76480f9746eced28718c5d78ee3c938b640282e6))
* **HLS:** skip whitespace in attributes ([#3884](https://github.com/joeyparrish/shaka-player/issues/3884)) ([ea6c02a](https://github.com/joeyparrish/shaka-player/commit/ea6c02aece1510598a898c235e66335d20eabedb))
...
* Ignore network changes if ABR is disabled ([#3387](https://github.com/joeyparrish/shaka-player/issues/3387)) ([bf51b4b](https://github.com/joeyparrish/shaka-player/commit/bf51b4b1fb02ba3254807dfad39defdb16e2af34)), closes [#3385](https://github.com/joeyparrish/shaka-player/issues/3385)
* **image:** Fix HLS image track issues ([264c842](https://github.com/joeyparrish/shaka-player/commit/264c84249684ee809f53fd4117f9aab4e0a599ac)), closes [#3840](https://github.com/joeyparrish/shaka-player/issues/3840)
* **image:** Fix thumbnails issues ([#3858](https://github.com/joeyparrish/shaka-player/issues/3858)) ([087a9b4](https://github.com/joeyparrish/shaka-player/commit/087a9b489b030aa0dc80011ca4e0a0c7a4124ecd))
* **ios:** Fix CORS errors with side-loaded text in src= mode ([#3328](https://github.com/joeyparrish/shaka-player/issues/3328)) ([66d28b9](https://github.com/joeyparrish/shaka-player/commit/66d28b9c888086dd20a0064e9fa5f39c61e0e323)), closes [#3312](https://github.com/joeyparrish/shaka-player/issues/3312)
* **LL-DASH:** Append segment chunk strictly in order ([#3405](https://github.com/joeyparrish/shaka-player/issues/3405)) ([f09616f](https://github.com/joeyparrish/shaka-player/commit/f09616fb41941d58d42d3037807f1c5c785accbc)), closes [#3404](https://github.com/joeyparrish/shaka-player/issues/3404)
* **LL-DASH:** Fix index out of bound issue when parsing mp4 segment ([#3403](https://github.com/joeyparrish/shaka-player/issues/3403)) ([e02d28c](https://github.com/joeyparrish/shaka-player/commit/e02d28c7656e2fc7183c9a1b4a004c721306c97e)), closes [#3402](https://github.com/joeyparrish/shaka-player/issues/3402)
* **ll-hls:** get discontinuity sequence number with skipped segments ([34c3133](https://github.com/joeyparrish/shaka-player/commit/34c3133077acaf1009fce559dd16e07ef2609773))
* **ll-hls:** Only read PART-HOLD-BACK value when appropriate ([2d68453](https://github.com/joeyparrish/shaka-player/commit/2d68453c7c8bab5f2164d430b864636fecd5d778))
* Load image streams for offline multiperiod ([4f4f6b1](https://github.com/joeyparrish/shaka-player/commit/4f4f6b1cf3025983dde05866a02238e180d71465)), closes [#3383](https://github.com/joeyparrish/shaka-player/issues/3383)
* Make ARIA polyfill more robust ([b185b3c](https://github.com/joeyparrish/shaka-player/commit/b185b3c9eab0d9a033b973dcdd6d855d342bfe86))
* **MCap:** Fix the default DRM session type w/ MCap ([6047fad](https://github.com/joeyparrish/shaka-player/commit/6047fad2c838ec538890f6cbfeae261775390cec))
* **MediaCap:** Default video width and height to 1 ([8d4fbf6](https://github.com/joeyparrish/shaka-player/commit/8d4fbf691ea4bfe6de7afd4f3d39ae70597ecb12)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **mediaCap:** do not newInitData before mediaKeys is ready ([f6f2817](https://github.com/joeyparrish/shaka-player/commit/f6f2817054bb64b1fb70b2002357188ffeb8722d))
* **MediaCap:** Fix VP9 codec unit test ([df1a110](https://github.com/joeyparrish/shaka-player/commit/df1a110c19bf1d45bd8786ee57455bdf23082093))
* **MediaCap:** update EME polyfill version ([c2db6d4](https://github.com/joeyparrish/shaka-player/commit/c2db6d4896a32d86aae13ed248ab07574a7ea634)), closes [#1391](https://github.com/joeyparrish/shaka-player/issues/1391)
* **media:** Fix playback of some multi-Period content. ([78357ed](https://github.com/joeyparrish/shaka-player/commit/78357ed785bdf450df6935943723f4c2bafae6ae)), closes [#3230](https://github.com/joeyparrish/shaka-player/issues/3230)
...
* **offline:** Do not apply CMCD query args to offline URIs ([#3716](https://github.com/joeyparrish/shaka-player/issues/3716)) ([173ae42](https://github.com/joeyparrish/shaka-player/commit/173ae42cdde973f6cb8a96a5e62057ddacd2a823)), closes [#3712](https://github.com/joeyparrish/shaka-player/issues/3712)
* **offline:** Fix error when un-storing DRM asset ([23e0d76](https://github.com/joeyparrish/shaka-player/commit/23e0d764a0ab58645d7e5fc953f524a49126920e)), closes [#3534](https://github.com/joeyparrish/shaka-player/issues/3534)
...
* Pass MIME data for src= to DRM setup ([f0f4109](https://github.com/joeyparrish/shaka-player/commit/f0f41098b6dde3e184cca65ae128e576352226cb)), closes [#3366](https://github.com/joeyparrish/shaka-player/issues/3366)
...
* **player:** Fix resolution changes with lang change. ([38c5081](https://github.com/joeyparrish/shaka-player/commit/38c50818890f9c0fb21af6edf2ac9c5cce187e48)), closes [#3262](https://github.com/joeyparrish/shaka-player/issues/3262) [#3288](https://github.com/joeyparrish/shaka-player/issues/3288)
* Rearrange checking & also check second period ([51f6c10](https://github.com/joeyparrish/shaka-player/commit/51f6c10b02c0466eb91cf28cf75f58826a1edb75))
* Reset forced subs between loads ([e9dc36d](https://github.com/joeyparrish/shaka-player/commit/e9dc36d13dbfb7cb8f3d98063a19059f343863a1))
...
* Show captions with rapid seek when ignoreTextStreamFailures is true ([#3476](https://github.com/joeyparrish/shaka-player/issues/3476)) ([8aa3e9d](https://github.com/joeyparrish/shaka-player/commit/8aa3e9da702c0ccfcf6ef6f0ac522e5efc780fa4))
* Support multiple chapter tracks with same language ([#3868](https://github.com/joeyparrish/shaka-player/issues/3868)) ([8c626ae](https://github.com/joeyparrish/shaka-player/commit/8c626aec238c01ebad7ccd06c9313e4f2e99d383)), closes [#3597](https://github.com/joeyparrish/shaka-player/issues/3597)
* **text:** Allow comments in the TTML parser ([#3827](https://github.com/joeyparrish/shaka-player/issues/3827)) ([c5a81f5](https://github.com/joeyparrish/shaka-player/commit/c5a81f53fe8d7b523523c0d1ed5431542383c80d)), closes [#3766](https://github.com/joeyparrish/shaka-player/issues/3766)
* **text:** Don't use flex layout in subtitles. ([9c2315e](https://github.com/joeyparrish/shaka-player/commit/9c2315e69db3f855349db0e0e5e32a1aa5b9647c)), closes [#3013](https://github.com/joeyparrish/shaka-player/issues/3013)
* **text:** Fix caption overlap. ([bf67d87](https://github.com/joeyparrish/shaka-player/commit/bf67d87387b1dfc4d3d8e0661bfe4efb1e4083b2)), closes [#3850](https://github.com/joeyparrish/shaka-player/issues/3850) [#3741](https://github.com/joeyparrish/shaka-player/issues/3741)
* **text:** Fix timestamp offset of CEA-608 cues ([b6d7138](https://github.com/joeyparrish/shaka-player/commit/b6d71384660952a79a0cf0d41f9ad2898a03eb02)), closes [#3782](https://github.com/joeyparrish/shaka-player/issues/3782)
* **text:** Fix UI test failures ([7da2cd5](https://github.com/joeyparrish/shaka-player/commit/7da2cd59ff7c9a019c13d23f6e73af1c065ed4d3)), closes [#3689](https://github.com/joeyparrish/shaka-player/issues/3689)
* **text:** Fix webvtt offset in sequence mode ([#3955](https://github.com/joeyparrish/shaka-player/issues/3955)) ([a4e9267](https://github.com/joeyparrish/shaka-player/commit/a4e926772e1b754fe968ee6f97490f08a40fe535)), closes [#2337](https://github.com/joeyparrish/shaka-player/issues/2337)
* **text:** Fixes minor bug with cue updating ([a4e348d](https://github.com/joeyparrish/shaka-player/commit/a4e348da7bf9d42276c05f35ed75c3ac5ec3ce23))
* **text:** Force caption update when removing cues ([4bdd3bb](https://github.com/joeyparrish/shaka-player/commit/4bdd3bb65a62df3ca91dc340cac5b5d699b56b9c))
* **text:** Handle embedded->non-embedded cc switch ([567eb02](https://github.com/joeyparrish/shaka-player/commit/567eb02833efc6c06fabf3d3615e3c0c9efd1a38)), closes [#3199](https://github.com/joeyparrish/shaka-player/issues/3199)
* **text:** Inherit alignment from regions. ([e9df8fb](https://github.com/joeyparrish/shaka-player/commit/e9df8fb10c3752cb833e89c8ac793241497e29b6))
* **text:** Made nested cues inherit region ([#3837](https://github.com/joeyparrish/shaka-player/issues/3837)) ([3ff48cb](https://github.com/joeyparrish/shaka-player/commit/3ff48cba9b28a29e8decc11898e326d7918bc8f4)), closes [#3743](https://github.com/joeyparrish/shaka-player/issues/3743)
* **text:** Remove caption wrapper bgColor ([#3838](https://github.com/joeyparrish/shaka-player/issues/3838)) ([0117441](https://github.com/joeyparrish/shaka-player/commit/0117441bb06e0325b84666d2a5a76c0c2de81725)), closes [#3745](https://github.com/joeyparrish/shaka-player/issues/3745)
* **text:** support stpp.ttml codec in Mp4TtmlParser ([#3754](https://github.com/joeyparrish/shaka-player/issues/3754)) ([9e5b9ac](https://github.com/joeyparrish/shaka-player/commit/9e5b9ac1399e6a2772c7405de20f786ee1504331))
* Tolerate misaligned TS files ([20f3cb0](https://github.com/joeyparrish/shaka-player/commit/20f3cb0bc33a8933e51c304ffe623a38c16406f1)), closes [#3580](https://github.com/joeyparrish/shaka-player/issues/3580)
...
* **TTML:** fix image subtitles parsing in TTML ([#3294](https://github.com/joeyparrish/shaka-player/issues/3294)) ([9f54c41](https://github.com/joeyparrish/shaka-player/commit/9f54c418602cc5b4ec543b8b34761a19d0fa8f32)), closes [#3097](https://github.com/joeyparrish/shaka-player/issues/3097) [#3248](https://github.com/joeyparrish/shaka-player/issues/3248)
* **ttml:** Fix ttml erroneously dismissing cues. ([157bd77](https://github.com/joeyparrish/shaka-player/commit/157bd77be25ea7744d2d905f46dd3ee3eb1a611a)), closes [#3643](https://github.com/joeyparrish/shaka-player/issues/3643)
* Typings & remove unrelated tests ([e248db4](https://github.com/joeyparrish/shaka-player/commit/e248db408821568b73d62abfa58ea525b2f41ac1))
...
* **ui:** Control panel alignment ([#3650](https://github.com/joeyparrish/shaka-player/issues/3650)) ([c55ce6c](https://github.com/joeyparrish/shaka-player/commit/c55ce6c11b655f53f3354e7ce67a9c88e1c9bce2))
* **ui:** Fix cross-browser focus outline ([f676fed](https://github.com/joeyparrish/shaka-player/commit/f676fed569e3bcf262871a1f0930ebf2f895829a)), closes [#2863](https://github.com/joeyparrish/shaka-player/issues/2863)
* **ui:** Fix holding keyboard controls ([#3267](https://github.com/joeyparrish/shaka-player/issues/3267)) ([e933c36](https://github.com/joeyparrish/shaka-player/commit/e933c368b837592f0546011e8aedc273c21135af))
* **ui:** Fix Russian translation ([#3751](https://github.com/joeyparrish/shaka-player/issues/3751)) ([3092063](https://github.com/joeyparrish/shaka-player/commit/3092063479f54dd21e2f86dfd27e013ffa69a87c))
* **UI:** Fix spinner display ([a59559f](https://github.com/joeyparrish/shaka-player/commit/a59559f71918608ca9477c37c84e9c92cca888dd))
* **ui:** Fix styling of UI text cues ([cdeffbb](https://github.com/joeyparrish/shaka-player/commit/cdeffbb9e6afcc68cb2165bcc0c99be20c9cb153)), closes [#3521](https://github.com/joeyparrish/shaka-player/issues/3521) [#3600](https://github.com/joeyparrish/shaka-player/issues/3600) [#3713](https://github.com/joeyparrish/shaka-player/issues/3713)
* **UI:** Fix text UI not updating when text is disabled ([#3867](https://github.com/joeyparrish/shaka-player/issues/3867)) ([9f53d39](https://github.com/joeyparrish/shaka-player/commit/9f53d394279066f29a2d391b6964cba11c4a3e1e)), closes [#3728](https://github.com/joeyparrish/shaka-player/issues/3728)
* **UI:** Fix time element height on Safari ([#3809](https://github.com/joeyparrish/shaka-player/issues/3809)) ([680ab22](https://github.com/joeyparrish/shaka-player/commit/680ab22acaaf58e870d922bff054f5d524eee875)), closes [#3739](https://github.com/joeyparrish/shaka-player/issues/3739)
* **UI:** Fix writing-mode on Tizen 3 ([fff9a96](https://github.com/joeyparrish/shaka-player/commit/fff9a96958ce8493afa3994096f030173765e7ee))
* **UI:** Fix writing-mode support in old versions of Tizen and WebOS ([#3330](https://github.com/joeyparrish/shaka-player/issues/3330)) ([7af44ef](https://github.com/joeyparrish/shaka-player/commit/7af44ef5653618f79735ffa98beff08f9081f2b5))
* **UI:** Fixed details on failure to load. ([6c528c8](https://github.com/joeyparrish/shaka-player/commit/6c528c8f4ae199140d8bc64eac7f5774346e7c6f)), closes [#3388](https://github.com/joeyparrish/shaka-player/issues/3388)
* **ui:** Play video with the previous speed after pause ([9e2a585](https://github.com/joeyparrish/shaka-player/commit/9e2a5855e630b67a434ec3f56f04f8c4e71ce43d)), closes [#3261](https://github.com/joeyparrish/shaka-player/issues/3261)
* **ui:** Show replay icon instead of play when video ends ([#3253](https://github.com/joeyparrish/shaka-player/issues/3253)) ([ba98641](https://github.com/joeyparrish/shaka-player/commit/ba9864104625589bd7b72cda30be0ec5094b2200)), closes [#3247](https://github.com/joeyparrish/shaka-player/issues/3247)
* **UI:** Stop using setAttribute for ARIA ([#3489](https://github.com/joeyparrish/shaka-player/issues/3489)) ([3b2f7db](https://github.com/joeyparrish/shaka-player/commit/3b2f7dba042f62250dddf9a67dfb7d83da86c631))
* **UI:** Update Play icon after seeking from end ([#3515](https://github.com/joeyparrish/shaka-player/issues/3515)) ([8b418bb](https://github.com/joeyparrish/shaka-player/commit/8b418bb13c71a71486bcc6749226266cb76abd37))
* Update Cast receiver ID for v3.2 ([1b2fa84](https://github.com/joeyparrish/shaka-player/commit/1b2fa840d9b383d659fe515c1ec27a23414447cc))
* Use "undetermined" for missing CC language ([3cc9ec5](https://github.com/joeyparrish/shaka-player/commit/3cc9ec50b42e5939ddcdc2f6f650076fd979960e))
* Use period ID instead of start time ([84f4578](https://github.com/joeyparrish/shaka-player/commit/84f45780aa5487b172d8eefe602f758fd76408a1))
* **util:** Made |MultiMap.remove| clear empty keys ([c1e817d](https://github.com/joeyparrish/shaka-player/commit/c1e817d1a96502250883314709a0811f0f52357b))
* Work around override of MediaCapabilities polyfill in Apple browsers ([#3668](https://github.com/joeyparrish/shaka-player/issues/3668)) ([31c0cd4](https://github.com/joeyparrish/shaka-player/commit/31c0cd4b8ca0daec1cd7760bffe2bd5376a7f5ab)), closes [#3530](https://github.com/joeyparrish/shaka-player/issues/3530)
